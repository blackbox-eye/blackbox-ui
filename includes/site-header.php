...
<html lang="<?= htmlspecialchars($current_language) ?>" data-lang="<?= htmlspecialchars($current_language) ?>" class="scroll-smooth" data-theme="dark">
    ...
    <?php $css_version = '1.6.15'; // Cache-bust version - increment on CSS changes ?>
                    ...
                    <div class="header-actions bbx-header-right">
                        ...
                        <div class="console-access-dropdown" id="login-dropdown-container" data-dropdown>
                            <button type="button" 
                                ...
                                onclick="(function(e){e.preventDefault();e.stopPropagation();var btn=this;var isOpen=btn.getAttribute('aria-expanded')==='true';btn.setAttribute('aria-expanded',isOpen?'false':'true');console.log('INLINE CLICK - new state:',!isOpen)}).call(this,event)">
