        ...
        <div class="container mx-auto px-4 py-8 sm:py-10 lg:py-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 text-sm">
                <div class="sm:col-span-2 lg:col-span-1 text-center sm:text-left">
                    <h4 class="font-semibold text-gray-200 mb-3 sm:mb-4"><?= t('site.name') ?></h4>
                    <p class="text-gray-300"><?= t('footer.tagline') ?></p>
                </div>
                <div class="text-center sm:text-left">
                    <h4 class="font-semibold text-gray-200 mb-3 sm:mb-4"><?= t('footer.offices.title') ?></h4>
                    <div class="space-y-3 sm:space-y-4 text-gray-300">
                        <div>
                            <p class="font-bold text-gray-200"><?= t('footer.offices.switzerland') ?></p>
                            <p class="text-xs sm:text-sm"><?= t('footer.offices.switzerland_address') ?></p>
                        </div>
                        <div>
                            <p class="font-bold text-gray-200"><?= t('footer.offices.uae') ?></p>
                            <p class="text-xs sm:text-sm"><?= t('footer.offices.uae_address') ?></p>
                        </div>
                    </div>
                </div>
                <div class="text-center sm:text-left">
                    <h4 class="font-semibold text-gray-200 mb-3 sm:mb-4"><?= t('footer.contact.title') ?></h4>
                    <ul class="space-y-2 text-gray-300">
                        <li class="text-xs sm:text-sm"><?= t('footer.contact.email') ?></li>
                        <li class="text-xs sm:text-sm"><?= t('footer.contact.phone') ?></li>
                    </ul>
                </div>
                <div class="text-center sm:text-left">
                    <h4 class="font-semibold text-gray-200 mb-3 sm:mb-4"><?= t('footer.social.title') ?></h4>
