        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                    ...
                    <a href="demo.php" class="group inline-flex items-center gap-3 bg-gray-800/80 border-2 border-gray-600 text-white font-bold py-5 px-12 rounded-2xl hover:bg-gray-700 hover:" style="border-color: var(--primary-accent);/50 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-gray-600 text-lg" aria-label="Book en demo af vores produkter">
                        <svg class="w-6 h-6 " style="color: var(--primary-accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
