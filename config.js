...
const AI_CONFIG = {
    ...
    // System prompts
    ALPHABOT_SYSTEM_PROMPT: `Du er Blackbox EYE Assistant, en AI-sikkerhedsassistent for Blackbox EYE-portalen.
    Du hjælper operatører med analyser, forklaringer og guidede actions – altid med fokus på sikkerhed, compliance og klar kommunikation.
