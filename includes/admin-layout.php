    ...
    <nav class="command-deck"
      ...
      <div class="command-deck__actions">
        ...
        <button type="button"
          ...
          title="Skift tema"
          aria-label="Skift mellem mørkt og lyst tema">
          <svg class="theme-icon theme-icon--dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
          ...
          <svg class="theme-icon theme-icon--light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
