    ...
    <section class="py-16 sm:py-20 section-fade-in page-section">
        <div class="container mx-auto px-4">
            <div class="text-center max-w-3xl mx-auto mb-12">
                <p class=" uppercase tracking-widest text-sm font-semibold mb-4" style="color: var(--text-gold);"><?= t('pricing.subtitle') ?></p>
            ...
            <div class="max-w-4xl mx-auto glass-effect rounded-3xl p-6 sm:p-8 lg:p-10 mb-16">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
                    <div>
                        <label for="industry-select" class="block text-sm font-medium text-gray-200 mb-2"><?= t('pricing.ai_advisor.industry_label') ?></label>
                        <select id="industry-select" class="w-full bg-gray-800/60 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-gray-100 focus:outline-none focus:ring-2" style="--tw-ring-color: var(--text-gold);">
                    ...
                    <div>
                        <label for="employee-count" class="block text-sm font-medium text-gray-200 mb-2"><?= t('pricing.ai_advisor.employees_label') ?></label>
                        <input type="number" id="employee-count" value="50" min="1" class="w-full bg-gray-800/60 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-2" style="--tw-ring-color: var(--text-gold);">
                    </div>
                    <div class="lg:self-end">
                        <button id="get-recommendation-btn" class="w-full border-2" style="background: rgba(232, 197, 71, 0.14); border-color: var(--text-gold); color: var(--text-gold); font-semibold py-2.5 px-4 rounded-lg transition-colors">
                ...
                <div id="recommendation-result-container" class="mt-6 hidden" style="min-height:150px;">
                    <div class="border-t border-gray-700 pt-6">
                        <div id="recommendation-loader" class="flex flex-col items-center justify-center text-center">
                            ...
                            <p class="mt-4 text-gray-200"><?= t('pricing.ai_advisor.analyzing') ?></p>
                        </div>
            ...
            <div id="pricing-calculator"
                ...
                <form id="pricing-calculator-form" class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start" novalidate>
                    <div class="space-y-6">
                        <div>
                            <label for="calc-users" class="block text-sm font-medium text-gray-200 mb-2"><?= t('pricing.calculator.users_label') ?></label>
                            <input
                                type="number"
                                id="calc-users"
                                name="users"
                                class="w-full bg-gray-800/60 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-2" style="--tw-ring-color: var(--text-gold);"
                                min="1"
                                step="1"
                                inputmode="numeric"
                                required
                        ...
                        <div>
                            <label for="calc-endpoints" class="block text-sm font-medium text-gray-200 mb-2"><?= t('pricing.calculator.endpoints_label') ?></label>
                            <input
                                type="number"
                                id="calc-endpoints"
                                name="endpoints"
                    ...
                    <div class="space-y-6">
                        <fieldset>
                            <legend class="block text-sm font-medium text-gray-200 mb-2"><?= t('pricing.calculator.addons_label') ?></legend>
                            ...
                            <div class="space-y-3" role="group" aria-describedby="calc-addons-help">
                                <label class="flex items-start gap-3 bg-gray-800/50 border border-gray-700 rounded-xl px-4 py-3  transition-colors">
                                    <input type="checkbox" class="mt-1 accent-color" style="accent-color: var(--text-gold);" name="addons" value="pve">
                                ...
                                <label class="flex items-start gap-3 bg-gray-800/50 border border-gray-700 rounded-xl px-4 py-3  transition-colors">
                                    <input type="checkbox" class="mt-1 accent-color" style="accent-color: var(--text-gold);" name="addons" value="aut">
                                    <span class="text-sm text-gray-200">
                                ...
                                <label class="flex items-start gap-3 bg-gray-800/50 border border-gray-700 rounded-xl px-4 py-3  transition-colors">
                                    <input type="checkbox" class="mt-1 accent-color" style="accent-color: var(--text-gold);" name="addons" value="bridge">
                                    <span class="text-sm text-gray-200">
                                ...
                                <label class="flex items-start gap-3 bg-gray-800/50 border border-gray-700 rounded-xl px-4 py-3  transition-colors">
                                    <input type="checkbox" class="mt-1 accent-color" style="accent-color: var(--text-gold);" name="addons" value="support">
                                    <span class="text-sm text-gray-200">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <button type="submit" class="inline-flex items-center justify-center border-2" style="background: rgba(232, 197, 71, 0.14); border-color: var(--text-gold); color: var(--text-gold); backdrop-filter: blur(8px); font-semibold py-3 px-6 rounded-lg  transition-colors" data-loading-text="<?= htmlspecialchars(t('pricing.calculator.loading', 'Beregner...')) ?>">
                                <?= t('pricing.calculator.submit') ?>
                            </button>
                            <button type="reset" class="inline-flex items-center justify-center border border-gray-600 text-gray-200 font-semibold py-3 px-6 rounded-lg  hover:text-white transition-colors">
            ...
            <div class="pricing-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch mb-16">
                ...
                <article class="glass-effect rounded-2xl p-6 lg:p-8 text-center flex flex-col">
                    <div class="mb-3">
                        <span class="text-xs uppercase tracking-wider  font-semibold" style="color: var(--text-gold);"><?= t('pricing.mvp.basis.badge') ?></span>
                    </div>
                    <h2 class="text-xl lg:text-2xl font-bold mb-2"><?= t('pricing.mvp.basis.title') ?></h2>
                    <div class="text-3xl font-bold  mb-2" style="color: var(--text-gold);"><?= t('pricing.mvp.basis.price') ?></div>
                    ...
                    <ul class="text-left space-y-2 lg:space-y-3 text-gray-200 my-6 lg:my-8 flex-grow text-sm lg:text-base">
                ...
                <article class="glass-effect rounded-2xl p-6 lg:p-8 text-center flex flex-col min-h-[500px]">
                    ...
                    <div class="text-3xl font-bold  mb-2" style="color: var(--text-gold);"><?= t('pricing.mvp.pro.price') ?></div>
                ...
                <article class="glass-effect rounded-2xl p-6 lg:p-8 text-center flex flex-col min-h-[500px]">
                    <div class="mb-3">
                        <span class="text-xs uppercase tracking-wider  font-semibold" style="color: var(--text-gold);"><?= t('pricing.mvp.premium.badge') ?></span>
                    </div>
                    <h2 class="text-xl lg:text-2xl font-bold mb-2"><?= t('pricing.mvp.premium.title') ?></h2>
                    <div class="text-3xl font-bold  mb-2" style="color: var(--text-gold);"><?= t('pricing.mvp.premium.price') ?></div>
            ...
            <div class="pricing-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch mb-16">
                <article class="glass-effect rounded-2xl p-6 lg:p-8 text-center flex flex-col order-2 lg:order-1">
                    ...
                    <div class="text-3xl font-bold  mb-2" style="color: var(--text-gold);"><?= t('pricing.enterprise.standard.price') ?></div>
                ...
                <article class="relative glass-effect rounded-2xl p-6 lg:p-8 text-center border-2" style="border-color: var(--text-gold); flex flex-col min-h-[500px] order-1 lg:order-2 transform lg:scale-105 z-10">
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 border-2" style="background: rgba(232, 197, 71, 0.14); border-color: var(--text-gold); color: var(--text-gold); backdrop-filter: blur(8px); px-4 py-1 rounded-full text-xs lg:text-sm font-bold whitespace-nowrap"><?= t('pricing.enterprise.premium.badge') ?></div>
                    <h2 class="text-xl lg:text-2xl font-bold mb-2 mt-2"><?= t('pricing.enterprise.premium.title') ?></h2>
                    <div class="text-3xl font-bold  mb-2" style="color: var(--text-gold);"><?= t('pricing.enterprise.premium.price') ?></div>
                ...
                <article class="glass-effect rounded-2xl p-6 lg:p-8 text-center flex flex-col min-h-[500px] order-3">
                    ...
                    <div class="text-3xl font-bold  mb-2" style="color: var(--text-gold);"><?= t('pricing.enterprise.enterprise.price') ?></div>
