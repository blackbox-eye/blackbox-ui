    <footer class="bg-gradient-to-b from-gray-900/50 to-black border-t border-gray-800/50 mt-16 sm:mt-20 lg:mt-24 section-fade-in">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <div class="flex justify-center sm:justify-start gap-4">
                        <a href="#" class="group flex items-center justify-center w-10 h-10 rounded-lg bg-gray-800 hover:bg-amber-400 transition-all" aria-label="LinkedIn">
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-black transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                            </svg>
                        </a>
                        <a href="#" class="group flex items-center justify-center w-10 h-10 rounded-lg bg-gray-800 hover:bg-amber-400 transition-all" aria-label="Twitter">
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-black transition-colors" fill="currentColor" viewBox="0 0 24 24">
