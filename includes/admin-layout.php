  ...
  <?php if (!$hide_command_deck): ?>
    ...
    <nav class="command-deck"
      ...
      <div class="command-deck__actions">
        ...
        <button type="button"
          id="themeToggle"
          class="command-deck__action"
          title="Skift mellem mørkt og lyst tema"
          aria-label="Skift tema"
          aria-pressed="false"
          role="switch">
          <svg class="theme-icon theme-icon--dark" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
          ...
          <svg class="theme-icon theme-icon--light" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
            <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
          </svg>
          <span class="theme-toggle-label">Skift tema</span>
        </button>
